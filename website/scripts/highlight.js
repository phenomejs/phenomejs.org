...
function extendLanguage(lang) {
  ...
  Prism.languages[lang].context = /\b(?:this|self)\b/;
  ...
  Prism.languages[lang]['template-string'].inside.interpolation.inside.context = /\b(?:this|self)\b/;
  if (Prism.languages[lang].script) {
    Prism.languages[lang].script.inside.context = /\b(?:this|self)\b/;
  }
}
